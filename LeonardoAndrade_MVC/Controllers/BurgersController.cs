...
namespace LeonardoAndrade_MVC.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,WithCheese,Costo")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,WithCheese,Costo")] Burger burger)
        {
            if (id != burger.Id)
            {
                return NotFound();
