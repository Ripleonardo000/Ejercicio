...
namespace LeonardoAndrade_MVC.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(LeonardoAndrade_MVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BurgerID,Name,WithCheese,Costo")] Burger burger)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BurgerID,Name,WithCheese,Costo")] Burger burger)
        {
